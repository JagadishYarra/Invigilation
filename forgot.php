...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_email = mysqli_query($connection,"select email from detail where email='$email'");
...
$mail->Port = 587; 
$mail->Username = "vdhar1180@gmail.com";   //Enter your username/emailid
$mail->Password = "gibfjjmcegksxeom";   //Enter your password
